...
@section('admin')
    <div class="row">
        <div class="col-sm-12">
            <form action="{{ route('guru.store') }}" method="POST" class="row g-3 needs-validation"
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="pendidikan_terakhir" required
                                        ...
                                        <option selected value="" disabled>Pilih Pendidikan Terakhir</option>
                                        ...
                                        <option {{ old('pendidikan_terakhir') == 'D1' ? 'selected' : '' }} value="D1">
                                            D1
                                        </option>
                                        <option {{ old('pendidikan_terakhir') == 'D2' ? 'selected' : '' }} value="D2">
                                            D2
                                        </option>
                                        <option {{ old('pendidikan_terakhir') == 'D3' ? 'selected' : '' }} value="D3">
                                            D3
                                        </option>
                                        <option {{ old('pendidikan_terakhir') == 'D4' ? 'selected' : '' }} value="D4">
                                            D4
                                        </option>
                                        ...
                                        <option {{ old('pendidikan_terakhir') == 'S3' ? 'selected' : '' }} value="S3">
                                            S3
                                        </option>
                                    </select>
                                    <div class="invalid-feedback">
