    ...
    <div class="row mt-3">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-striped table-hover text-center fw-bold">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <form action="{{ route('settings.update', 1) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <td>
                                    <div class="col-auto">
                                        <input type="number" placeholder="Input No. Telepon" id="no_telp" name="no_telp"
                                            class="form-control text-danger" value="{{ $settings->no_telp ?? '' }}"
                                            required>
                                    </div>
                                </td>
                                <td>
