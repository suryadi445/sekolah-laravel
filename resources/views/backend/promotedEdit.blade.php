        ...
        <div class="col-md-12">
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group" role="group">
                                <a href="/promoted/exportPdf/{{ request()->segment(3) . '/' . request()->segment(4) . '/' . 'edit' }}"
                                    id="printPdf" target="_blank" class="btn btn-success">
                                    <span class="me-1">Print PDF</span>
                                    <i class="fa-solid fa-file-pdf"></i>
                                </a>
                                <a href="/promoted/exportExcel/{{ request()->segment(3) . '/' . request()->segment(4) . '/' . 'edit' }}"
                ...
                <div class="p-3 mt-2 table-responsive">
                    <form action="/promoted/update" method="POST" class="row g-3">
                        @csrf
                        @method('PUT')
                                ...
                                @if (count($siswas) > 0)
                                    @foreach ($siswas as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <input type="hidden" name="id_promoted[]"
                                                        value="{{ $item->id_promoted }}">
                                                ...
                                                <script>
                                                    $(document).ready(function() {
                                                        var defaultCheckedValues = ["option1", "option3"]; // Set your default values here

                                                        $.each(defaultCheckedValues, function(index, value) {
                                                            $('input[name="myCheckbox[]"][value="' + value + '"]').prop('checked', true);
                                                        });
                                                    });
                                                </script>
                                            </td>
