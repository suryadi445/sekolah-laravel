...
Route::get('/promoted/show/{kelas?}/{sub_kelas}', [PromotedController::class, 'show']);
Route::get('/promoted/edit/{kelas?}/{sub_kelas}', [PromotedController::class, 'edit']);
Route::put('/promoted/update/{id?}', [PromotedController::class, 'update']);
Route::post('/promoted/store', [PromotedController::class, 'store']);
Route::get('/promoted/exportPdf/{kelas?}/{subKelas?}/{param?}', [PromotedController::class, 'exportPdf']);
Route::get('/promoted/exportExcel/{kelas?}/{subKelas?}/{param?}', [PromotedController::class, 'exportExcel']);
...
Route::resource('/th_ajaran', ThAjaranController::class);
